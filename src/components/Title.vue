  ...
  <div class="jumbotron jumbotron-fluid gradient-custom p-5">
    <div class="container p-5">
      ...
      <div class="p-5 gap-3 download mx-auto">
        <p class="version text-light">We have released Version 1.0!</p>
        <a href="http://www.google.com">
          <button class="cybr-btn">Get it on Chrome<span aria-hidden>_!</span>
          <span aria-hidden class="cybr-btn__glitch">_ClearVue!</span>
          <span aria-hidden class="cybr-btn__tag">V1.0</span>
          </button>
        </a>
      </div>
      <div class="p-3"></div>
...
.gradient-custom {
  ...
  background: -webkit-linear-gradient(to bottom, rgba(71, 174, 129, 0.75), rgba(58, 60, 65, 0.75));

  /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
  background: linear-gradient(to bottom, rgba(71, 174, 129, 0.75), rgba(58, 60, 65, 0.35))
}
</style>
